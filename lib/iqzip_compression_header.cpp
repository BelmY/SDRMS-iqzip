...
namespace iqzip
{
  ...
  namespace compression
  {
    ...
    iqzip_compression_header::parse_header_from_file (std::string path)
    {
      ...
      hdr_src_cnf =
          (compression_identification_packet::source_data_variable_t*) (&buffer[CCSDS_PRIMARY_HEADER_SIZE
              + SOURCE_DATA_FIXED_SIZE]);
      hdr_src_cnf_fixed =
          (compression_identification_packet::source_data_fixed_t*) (&buffer[CCSDS_PRIMARY_HEADER_SIZE]);
