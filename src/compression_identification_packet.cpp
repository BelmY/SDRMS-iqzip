...
namespace iqzip
{
  ...
  compression_identification_packet::compression_identification_packet (
      ...
      uint8_t data_sense, uint8_t restricted_codes, uint8_t version,
      uint8_t type, uint8_t sec_hdr_flag, uint16_t apid, uint8_t sequence_flags,
  ...
  compression_identification_packet::write_header_to_file (std::string path)
  {
    ...
    fwrite (&(get_ccsds_primary_header ()),
